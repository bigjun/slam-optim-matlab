% test double difference slam

% lienar case
%clear all
close all

[meas,vertices,buoy,sigInit,sigState,sigObs,dt,A]=generateDataDoubleDifference;
...
% Constant velocity
dim = 6; % 3DOF pose + 3DOF velocity + 1DOF clock bias
dimb = 3;
...
while ~done
    % solve linear system
    [J,d] = linearSystemDoubleDifference(meas,poses,buoy,RInit,RState,RObs,dim,dimb,A,nd,nb);
